...
<details>
<summary><strong>repo-dashboard</strong> ([repo](https://github.com/KyleKing/repo-dashboard)) - K9s-inspired TUI for managing multiple git repositories</summary>
...
<details>
<summary><strong>gh-wfd</strong> ([repo](https://github.com/KyleKing/gh-wfd)) - Interactive GitHub Actions workflow dispatcher</summary>

![demo](https://raw.githubusercontent.com/kyleking/gh-wfd/main/.github/assets/demo.gif)

GitHub CLI extension for dispatching workflows with fuzzy selection, input configuration, and frecency-based history.
</details>

<details>
<summary><strong>tail-jsonl</strong> ([repo](https://github.com/KyleKing/tail-jsonl)) - Tail JSONL logs with pretty formatting</summary>
